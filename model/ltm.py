...
sys.path.append("/home/seil/packages/YellowFin/tuner_utils/")
...
class ltm_model(object):
    def __init__(self, flags, inputs):
        ...
        with tf.variable_scope('inputs'):
            self.long_cbp = layers.unit_norm(inputs=inputs['story'], dim=1, epsilon=1e-12)
